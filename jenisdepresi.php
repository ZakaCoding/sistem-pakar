...
<html lang="en">
  ...
  <div class="col-md-2 mt-2 pt-4 bg-dark">
      ...
      <div class="col-md-10 p-5 pt-5">
          <h4><i class="fas fa-disease"></i> JENIS DEPRESI</h4><hr>
          
          <div class="row">
          <!--- Tambah --->
            <div class="col-md-2">
                <a href="tambahpenyakit.php" class="btn btn-primary">Tambah</a>
            </div>
          ...
          <table class="table table-striped table-bordered">
              ...
              <?php
              $queri = "SELECT * FROM tb_penyakit order by kode_penyakit";
              ...
              while ($data = mysqli_fetch_array ($hasil)){  
                ...
                echo "      
				        ...
				        <td>".$data[1]."</td>  
      			        <td>".$data[2]."</td>  
      			        <td>".$data[3]."</td>  
                        <td><a href=\"editpenyakit.php?id=".$data[1]."\"><i class='fas fa-edit bg-success text-white p-2 rounded' data-toggle='tooltip' title='edit'></i></a>"."  <a href=\"deletepenyakit.php?id=".$data[1]."\" onclick='return checkDelete()'><i class='fas fa-trash-alt bg-danger text-white p-2 rounded' data-toggle='tooltip' title='hapus'></i></a>"."</td>
        		        </tr>   
          	        ";      
		      }
              ?>
