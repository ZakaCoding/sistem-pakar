...
<html lang="en">
  ...
  <div class="col-md-2 mt-2 pt-4 bg-dark">
      ...
      <div class="col-md-10 p-5 pt-5">
          <h4><i class="fas fa-thermometer-three-quarters mr-2"></i> DAFTAR GEJALA</h4><hr>
          
          <div class="row">
          <!--- Tambah --->
            <div class="col-md-2">
                <a href="tambahgejala.php" class="btn btn-primary">Tambah</a>
            </div>
          ...
          <table class="table table-striped table-bordered">
              ...
              <?php
              $queri = "SELECT * FROM tb_gejala order by kode_gejala";
              ...
              while ($data = mysqli_fetch_array ($hasil)){  
                ...
                echo "      
				        ...
				        <td>".$data[1]."</td>  
      			        <td>".$data[2]."</td>   
                        <td><a href=\"editgejala.php?id=".$data[1]."\"><i class='fas fa-edit bg-success text-white p-2 rounded' data-toggle='tooltip' title='edit'></i></a>"."  <a href=\"deletegejala.php?id=".$data[1]."\" onclick='return checkDelete()'><i class='fas fa-trash-alt bg-danger text-white p-2 rounded' data-toggle='tooltip' title='hapus'></i></a>"."</td>
        		        </tr>   
          	        ";      
		      }
              ?>
